...
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install mysql-client git apache2 libapache2-mod-php5 pwgen python-setuptools vim-tiny php5-mysql php-apc php5-gd php5-curl php5-memcache memcached drush mc curl
RUN DEBIAN_FRONTEND=noninteractive apt-get autoclean

# Install ffmpeg from gist
RUN curl -sSL http://bit.ly/1vLdRes | bash -s
